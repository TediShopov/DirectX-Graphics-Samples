...
#include "CompiledShaders/SurfelGIOnlyVS.h"
#include "CompiledShaders/SurfelGIOnlyPS.h"
...
public:
	...
	GraphicsPSO m_TestPSO = { (L"Surfel GI Visualizaiton PSO") };
	...
	void SetRootParameters(GraphicsContext& gfxContext, ColorBuffer& rayTracingOutColor); //	const Camera& camera);
