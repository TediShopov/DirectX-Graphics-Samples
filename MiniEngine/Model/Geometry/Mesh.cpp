...
//#include "mesh.h"
//
//Mesh::Mesh(ID3D12Device* device, ID3D12DeviceContext* deviceContext, WCHAR* textureFilename)
//{
//	bool result;
//	
...
//}
//
//ID3D12ShaderResourceView* Mesh::GetTexture()
//{
//	return m_Texture->GetTexture();
//}
//
//bool Mesh::InitBuffers(ID3D12Device* device)
//{
//	VertexType* vertices;
...
//
//
//void Mesh::SendData(ID3D12DeviceContext* deviceContext)
//{
//	unsigned int stride;
//	unsigned int offset;
//
...
//	deviceContext->IASetPrimitiveTopology(D3D12_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
//}
//
//void Mesh::LoadTexture(ID3D12Device* device, ID3D12DeviceContext* deviceContext, WCHAR* filename)
//{
